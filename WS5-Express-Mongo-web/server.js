...
app.post("/adduser", function(req, res) {
  /////////////////////////////////////////////////////
  // Salataan salasana tietokantaa varten
  /////////////////////////////////////////////////////
  ...
  var newUser = {
    ...
    password: newpass // req.body.pass
  };
  console.log(newUser);
  /////////////////////////////////////////////////////
...
app.post("/kirjaudu", function(req, res) {
  ...
  // JOS käytössä salasanan suojaus, etsitään pelkän tunnuksen perusteella, salasana vertailu
  // vasta jälkeenpäin
